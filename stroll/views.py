...
def home(request):
    ...
    context_dict["popular_walks"] = [{"thumbnail": "photo", "name": "my first walk", "area": "partickwwwwwwwwwwwwwwww", "tags": "hi,hello,good".split(","), 
                                      "difficulty": 1, "description": "Thuis is my really cool walk", "slug": "a"},
                                      {"thumbnail": "another_photo", "name": "my last walk", "area": "govan", "tags": "goodbye,fairwell,bad".split(","), 
                                      "difficulty": 4, "description": "Thuis is my really bad walk", "slug": "a"},
                                      {"thumbnail": "a_picture", "name": "my new walk", "area": "leith", "tags": "i,regret,this".split(","), 
